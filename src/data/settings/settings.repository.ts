...
export const useRepositoryAuth = () => {
  ...
  const getAllSession = async () => {
    try {
      ...
      toasterErrorHandling(err, 'Failed to get all sessions');
      throw err;
    } finally {
  ...
  const deleteAllSession = async () => {
    try {
      ...
      toasterErrorHandling(err, 'Failed to delete all sessions');
      throw err;
    } finally {
  ...
  const deleteOneSession = async (id: string) => {
    try {
      ...
      toasterErrorHandling(err, 'Failed to delete session');
      throw err;
    } finally {
  ...
  const setSettings = async (flowId: string, data: any, csrf_token: string) => {
    try {
      ...
      toasterErrorHandling(err, 'Failed to set settings');
      throw err;
    } finally {
  ...
  const getSettings = async (flowId: string) => {
    try {
      ...
      toasterErrorHandling(err, 'Failed to get settings');
      throw err;
    } finally {
