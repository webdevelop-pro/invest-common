...
export const useRepositoryInvestment = defineStore('repository-investment', () => {
  ...
  const getInvestments = async (id: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to fetch investments');
      throw err;
    } finally {
  ...
  const getInvestOne = async (id: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to fetch investment');
      throw err;
    } finally {
  ...
  const getInvestUnconfirmed = async (slug: string, profileId: number | string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to fetch unconfirmed investments');
      throw err;
    } finally {
  ...
  const setInvest = async (slug: string, profileId: string, sharesCount: number) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to set investment');
      throw err;
    } finally {
  ...
  const setAmount = async (slug: string, id: string, profileId: string, shares: number) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to set amount');
      throw err;
    } finally {
  ...
  const setOwnership = async (slug: string, id: string, profileId: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to set ownership');
      throw err;
    } finally {
  ...
  const setSignature = async (slug: string, id: string, profileId: string, signUrlId: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to set signature');
      throw err;
    } finally {
  ...
  const setFunding = async (slug: string, id: string, profileId: string, fundingData: IInvestFunding) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to set funding');
      throw err;
    } finally {
  ...
  const setReview = async (slug: string, id: string, profileId: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to set review');
      throw err;
    } finally {
  ...
  const cancelInvest = async (id: string, reason: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to cancel investment');
      throw err;
    } finally {
  ...
  const setAmountOptions = async (slug: string, id: string, profileId: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to get amount options');
      throw err;
    } finally {
  ...
  const setOwnershipOptions = async (slug: string, id: string, profileId: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to get ownership options');
      throw err;
    } finally {
  ...
  const setFundingOptions = async (slug: string, id: string, profileId: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to get funding options');
      throw err;
    } finally {
  ...
  const setCancelOptions = async (id: string) => {
    try {
      ...
      toasterErrorHandlingAnalytics(err, 'Failed to get cancel options');
      throw err;
    } finally {
