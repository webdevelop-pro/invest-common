...
export const useProfileEvmWalletTransactionStore = defineStore('EvmwalletTransaction', () => {
  const profileWalletStore = useProfileEvmWalletStore();
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useProfileEvmWalletTransactionStore, import.meta.hot));
}
